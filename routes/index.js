...
router.post('/reservations', function (req, res, next) {
  ...
  if (!req.body.name) {
    ...
    reservations.render(req, res, "Preencha o campo Nome.");

  } else if (!req.body.email) {

    reservations.render(req, res, "Preencha o campo Email.");

  } else if (!req.body.people) {

    reservations.render(req, res, "Preencha o numero de pessoas");
